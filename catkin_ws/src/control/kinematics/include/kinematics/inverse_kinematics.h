...
class InverseKinematics
{
    ...
    /// and false if not.
    public: bool SolveInverseKinematics(const Eigen::Vector3d &_pos, JointSpaceVector &_q);

    /// \brief The ValidateSolution function evaluates whether
    /// a set of joint angles is within joint limits. 
    /// \param[in] _q Joint angles generated by the IK solver.
    /// \return Evaluates true if IK solution is valid, and false if not.
    private: bool ValidateSolution(const JointSpaceVector &_q);
