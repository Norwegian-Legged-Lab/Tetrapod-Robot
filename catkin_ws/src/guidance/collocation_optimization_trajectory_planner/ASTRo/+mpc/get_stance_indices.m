...
stance_indices.fl.stance = mpc.is_stance('fl', tau_s, stance_info);
stance_indices.fr.stance = mpc.is_stance('fr', tau_s, stance_info);
stance_indices.rl.stance = mpc.is_stance('rl', tau_s, stance_info);
stance_indices.rr.stance = mpc.is_stance('rr', tau_s, stance_info);
