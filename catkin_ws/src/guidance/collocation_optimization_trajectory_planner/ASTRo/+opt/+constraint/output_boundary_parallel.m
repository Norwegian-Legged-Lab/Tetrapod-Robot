function output_boundary_parallel(nlp, bounds)
    
    domain = nlp.Plant;
    x = domain.States.x;

    y_pos = domain.VirtualConstraints.position;
    y_bound_idx = str_indices({'FrontStanceHipRoll', 'FrontStanceKneePitch', ...
        'RearStanceHipRoll', 'RearStanceKneePitch'}, y_pos.OutputLabel);
