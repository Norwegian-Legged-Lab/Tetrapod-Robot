...
test_system.Gamma.Nodes.Domain{3}.VirtualConstraints.position.setSelectionMatrix(H1);
test_system.Gamma.Nodes.Domain{4}.VirtualConstraints.position.setSelectionMatrix(H2);
%%
test_logger = test_system.simulate(0, x0, [], [], 'NumCycle', 12);
