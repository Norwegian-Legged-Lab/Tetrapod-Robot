...
#define J_D1Y_POSITION_DIAGONALSTANCE2_HH
...
namespace DiagonalStance2
{
  ...
  inline void J_d1y_position_DiagonalStance2(Eigen::MatrixXd &p_output1, const Eigen::VectorXd &var1,const Eigen::VectorXd &var2,const Eigen::VectorXd &var3,const Eigen::VectorXd &var4,const Eigen::VectorXd &var5,const Eigen::VectorXd &var6,const Eigen::VectorXd &var7)
  {
    // Check
    // - Inputs
    ...
    J_d1y_position_DiagonalStance2_raw(p_output1.data(), var1.data(),var2.data(),var3.data(),var4.data(),var5.data(),var6.data(),var7.data());
    }
...
#endif // J_D1Y_POSITION_DIAGONALSTANCE2_HH
