function DiagonalStanceConstraints1(nlp, bounds, varargin)
    ...
    opt.constraint.foot_clearance_trot(nlp, bounds, fl_foot_frame);
    opt.constraint.foot_clearance_trot(nlp, bounds, rr_foot_frame);
    ...
    % swing foot velocity
    opt.constraint.impact_velocity_trot(nlp, bounds, fl_foot_frame);
    opt.constraint.impact_velocity_trot(nlp, bounds, rr_foot_frame);
