function DiagonalStanceConstraints2(nlp, bounds, varargin)
    ...
    opt.constraint.foot_clearance(nlp, bounds, fr_foot_frame, rl_foot_frame);
    ...
    % swing foot velocity
    opt.constraint.impact_velocity(nlp, bounds, fr_foot_frame, rl_foot_frame);
