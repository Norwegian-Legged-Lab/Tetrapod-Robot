function bounds = GetBounds_4doms(model, speed)
    ...
    bounds.DiagonalStance1 = bounds.DiagonalStance;
    bounds.DiagonalStance2 = bounds.DiagonalStance;

    
    bounds.DiagonalStance1.inputs.ConstraintWrench.fFrFoot.lb = [-10000, -10000, 0]';
    bounds.DiagonalStance1.inputs.ConstraintWrench.fFrFoot.ub = [10000, 10000, 10000]';
    
    bounds.DiagonalStance1.inputs.ConstraintWrench.fRlFoot.lb = [-10000, -10000, 0]';
    bounds.DiagonalStance1.inputs.ConstraintWrench.fRlFoot.ub = [10000, 10000, 10000]';

    bounds.DiagonalStance2.inputs.ConstraintWrench.fFlFoot.lb = [-10000, -10000, 0]';
    bounds.DiagonalStance2.inputs.ConstraintWrench.fFlFoot.ub = [10000, 10000, 10000]';
    
    bounds.DiagonalStance2.inputs.ConstraintWrench.fRrFoot.lb = [-10000, -10000, 0]';
    bounds.DiagonalStance2.inputs.ConstraintWrench.fRrFoot.ub = [10000, 10000, 10000]';
    ...
    bounds.ParallelImpact1 = bounds.ParallelImpact;
    bounds.ParallelImpact2 = bounds.ParallelImpact;
    
    bounds.ParallelImpact1.inputs.ConstraintWrench.fFrFoot.lb = [-10000, -10000, 0]';
    bounds.ParallelImpact1.inputs.ConstraintWrench.fFrFoot.ub = [10000, 10000, 10000]';

    bounds.ParallelImpact1.inputs.ConstraintWrench.fRrFoot.lb = [-10000, -10000, 0]';
    bounds.ParallelImpact1.inputs.ConstraintWrench.fRrFoot.ub = [10000, 10000, 10000]';

    bounds.ParallelImpact2.inputs.ConstraintWrench.fFlFoot.lb = [-10000, -10000, 0]';
    bounds.ParallelImpact2.inputs.ConstraintWrench.fFlFoot.ub = [10000, 10000, 10000]';

    bounds.ParallelImpact2.inputs.ConstraintWrench.fRlFoot.lb = [-10000, -10000, 0]';
    bounds.ParallelImpact2.inputs.ConstraintWrench.fRlFoot.ub = [10000, 10000, 10000]';
    ...
    bounds.ParallelStance1 = bounds.ParallelStance;
    bounds.ParallelStance2 = bounds.ParallelStance;

    bounds.ParallelStance1.inputs.ConstraintWrench.fFrFoot.lb = [-10000, -10000, 0];
    bounds.ParallelStance1.inputs.ConstraintWrench.fFrFoot.ub = [10000, 10000, 10000];

    bounds.ParallelStance1.inputs.ConstraintWrench.fRrFoot.lb = [-10000, -10000, 0];
    bounds.ParallelStance1.inputs.ConstraintWrench.fRrFoot.ub = [10000, 10000, 10000];

    bounds.ParallelStance2.inputs.ConstraintWrench.fFlFoot.lb = [-10000, -10000, 0];
    bounds.ParallelStance2.inputs.ConstraintWrench.fFlFoot.ub = [10000, 10000, 10000];

    bounds.ParallelStance2.inputs.ConstraintWrench.fRlFoot.lb = [-10000, -10000, 0];
    bounds.ParallelStance2.inputs.ConstraintWrench.fRlFoot.ub = [10000, 10000, 10000];
    ...
    bounds.DiagonalImpact1 = bounds.DiagonalImpact;
    bounds.DiagonalImpact2 = bounds.DiagonalImpact;
    
    bounds.DiagonalImpact1.inputs.ConstraintWrench.fFlFoot.lb = [-10000, -10000, 0]';
    bounds.DiagonalImpact1.inputs.ConstraintWrench.fFlFoot.ub = [10000, 10000, 10000]';

    bounds.DiagonalImpact1.inputs.ConstraintWrench.fRrFoot.lb = [-10000, -10000, 0]';
    bounds.DiagonalImpact1.inputs.ConstraintWrench.fRrFoot.ub = [10000, 10000, 10000]';

    bounds.DiagonalImpact2.inputs.ConstraintWrench.fFrFoot.lb = [-10000, -10000, 0]';
    bounds.DiagonalImpact2.inputs.ConstraintWrench.fFrFoot.ub = [10000, 10000, 10000]';

    bounds.DiagonalImpact2.inputs.ConstraintWrench.fRlFoot.lb = [-10000, -10000, 0]';
    bounds.DiagonalImpact2.inputs.ConstraintWrench.fRlFoot.ub = [10000, 10000, 10000]';
