...
int main(int argc, char **argv)
{
    ...
    footstep_planner::DecVarsRes foot_res = footstep_planner::PlanSequence(terrain, init_f_pos, goal_f_pos, n_steps, n_legs, length_legs, step_sequence, bbox_len, step_span, step_height);
