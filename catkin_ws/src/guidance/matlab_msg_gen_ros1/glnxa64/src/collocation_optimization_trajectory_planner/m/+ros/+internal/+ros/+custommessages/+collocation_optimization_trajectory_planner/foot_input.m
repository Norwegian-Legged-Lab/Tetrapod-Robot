...
%foot_input gives an empty data for collocation_optimization_trajectory_planner/foot_input
% Copyright 2019-2020 The MathWorks, Inc.
%#codegen
data = struct();
data.MessageType = 'collocation_optimization_trajectory_planner/foot_input';
[data.StanceIndices, info.StanceIndices] = ros.internal.ros.messages.ros.default_type('logical',NaN);
[data.DStanceIndices, info.DStanceIndices] = ros.internal.ros.messages.ros.default_type('logical',NaN);
...
info.MessageType = 'collocation_optimization_trajectory_planner/foot_input';
info.constant = 0;
info.default = 0;
info.maxstrlen = NaN;
info.MaxLen = 1;
