...
classdef solveMpcRequest < ros.Message
    %solveMpcRequest MATLAB implementation of collocation_optimization_trajectory_planner/solveMpcRequest
    %   This class was automatically generated by
    %   ros.internal.pubsubEmitter.
    %   Copyright 2014-2020 The MathWorks, Inc.
    properties (Constant)
        MessageType = 'collocation_optimization_trajectory_planner/solveMpcRequest' % The ROS message type
    end
    properties (Constant, Hidden)
        ...
        PropertyMessageTypes = { 'ros.msggen.collocation_optimization_trajectory_planner.init_pos' ...
            '' ...
            '' ...
            '' ...
            '' ...
    ...
    methods
        function set.InitStancePos(obj, val)
            ...
            validClasses = {'ros.msggen.collocation_optimization_trajectory_planner.init_pos'};
    ...
    methods (Static, Access = {?matlab.unittest.TestCase, ?ros.Message})
        ...
        % Return an empty object array if the structure element is not defined
            if isempty(strObj)
                obj = ros.msggen.collocation_optimization_trajectory_planner.solveMpcRequest.empty(0,1);
                return
            end
            % Create an empty message object
            obj = ros.msggen.collocation_optimization_trajectory_planner.solveMpcRequest(strObj);
        end
    end
end
