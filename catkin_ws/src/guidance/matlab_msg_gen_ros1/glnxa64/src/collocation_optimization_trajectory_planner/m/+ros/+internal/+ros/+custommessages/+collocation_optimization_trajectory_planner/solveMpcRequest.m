...
%solveMpcRequest gives an empty data for collocation_optimization_trajectory_planner/solveMpcRequest
% Copyright 2019-2020 The MathWorks, Inc.
%#codegen
data = struct();
data.MessageType = 'collocation_optimization_trajectory_planner/solveMpcRequest';
...
[data.InitStancePos, info.InitStancePos] = ros.internal.ros.custommessages.collocation_optimization_trajectory_planner.init_pos;
...
info.MessageType = 'collocation_optimization_trajectory_planner/solveMpcRequest';
info.constant = 0;
info.default = 0;
info.maxstrlen = NaN;
info.MaxLen = 1;
