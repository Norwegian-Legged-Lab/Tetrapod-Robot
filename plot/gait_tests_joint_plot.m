...
% Physical results for report %
path = "~/Tetrapod-Robot/bagfiles/gait_tests/";
% test_case1 = "2021-07-26-16-36-24"; % Pretty successful tripping for a long time. Small velocity commands were given
test_case1 = "2021-07-26-18-51-23"; % Attempted walking. Robot slipped eventually
...
joint_tor_ylimits = {[-5,5], [-20,20], [-10,10]};
...
set(gcf, 'Position',  [100, 100, 2480, 3508])
...
filename1 = 'gait_test_standup_joint_pos.pdf';
filename2 = 'gait_test_standup_cases_joint_vel.pdf';
filename3 = 'gait_test_standup_joint_tor.pdf';


exportgraphics(fig1, filename1, 'BackgroundColor','none')
exportgraphics(fig2, filename2, 'BackgroundColor','none')
exportgraphics(fig3, filename3, 'BackgroundColor','none')
